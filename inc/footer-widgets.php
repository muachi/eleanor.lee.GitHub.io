...
class Selfgraphy_Pro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'selfgraphy_pro';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'selfgraphy-pro' ), $i ),
...
// Initialize.
$selfgraphy_pro_footer_widgets = new Selfgraphy_Pro_Footer_Widgets();
