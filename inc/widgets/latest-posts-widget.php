...
if ( ! class_exists( 'Selfgraphy_Pro_Latest_Post' ) ) :

     
    class Selfgraphy_Pro_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'selfgraphy-pro' ),
            );
            parent::__construct( 'selfgraphy_pro_latest_post', esc_html__( 'TP : Latest Posts', 'selfgraphy-pro' ), $tp_widget_popular_post );
        }
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'selfgraphy-pro' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>
